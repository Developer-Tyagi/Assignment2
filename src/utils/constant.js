export const constants = {
  ...
  successMessages: {
    ...
    CLAIM_FAILED: 'Failed to Add Claim !',
    CLIENT: 'Client Created Successfully !',
    CLIENT_CLAIM_CREATED: 'Client and Claim Created Successfully !',
    CLIENT_CLAIM_FAILED: 'Failed in Creating Client and Claim',
    ...
    CLIENT_INFO_FAILED: 'Failed to Update Client Info!',
