  ...
  <q-page class="custom-font full-height">
    <div class="row" style="height: calc(100vh - 1px)">
      ...
      >
        ...
        <div class="column justify-center text-h4 text-weight-bolder">
          <div style="text-align: center">
            The First and Only Catastrophe -Proof
          </div>
          <div style="text-align: center">
            Claim management System for Public
          </div>
          <div style="text-align: center">Adjusters</div>
        </div>
        ...
        <div class="row wrap justify-around items-start content-start q-mt-md">
          <q-card
          ...
          >
            ...
            <q-card-section>
              <div
                class="text-subtitle1 col-md-4 col-xs-12 col-sm-12"
                style="text-align: justify"
                v-for="firmPackage in firmPackages"
                :key="firmPackage"
              >
                <q-btn round dense flat color="orange" icon="check_circle" />
                {{ firmPackage }}
              </div>
            </q-card-section>
            <q-card-section>
              <div class="q-ml-lg text-blue-grey text-subtitle1">
          ...
          >
            ...
            <q-card-section style="min-height: 270px">
              <div
                class="text-subtitle1 col-md-4 col-xs-12 col-sm-12"
      ...
      >
        <div class="row">
          ...
          <div class="col-8">
            ...
            <q-form class="q-mt-xl" @submit="onContinue()" ref="orgInfo">
              <div class="text-h3 text-weight-bolder">Subscribe Now</div>
              ...
              <div class="q-mt-md"></div>
              <label class="text-h6 text-weight-bolder">Email Address</label>
              <q-input
              ...
              <div class="q-mt-md"></div>
              <label class="text-h6 text-weight-bolder">Password</label>
              <q-input
                color="primary"
              ...
              <div class="q-mt-md"></div>
              <label class="text-h6 text-weight-bolder">Company Name</label>
              <q-input
              ...
              <div class="row justify-center q-mt-sm">
                ...
                <div class="col-8 q-ml-md">
                  <label class="text-subtitle1 q-ml-xl"
                    >Already have an account?</label
                  >
                  <a href="/login" class="q-ml-sm text-deep-orange">login</a>
                </div>
                <div class="col-2"></div>
              </div>
            </q-form>
