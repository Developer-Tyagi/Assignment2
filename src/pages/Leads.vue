  ...
  <q-page padding>
    ...
    <q-list bordered separator>
     <q-item 
       ...
       v-for="(lead) in leadsData" :key="lead.id" class="q-my-sm" clickable v-ripple>
       ...
       <q-item-section side top>  
          ...
          <small><q-item-label>Schedule to visit</q-item-label>    </small>
          
          <q-icon name="sync" color="red"></q-icon> 
          </div>
          <div v-else>
            <small><q-item-label>Visited on {{lead.attributes.lastVisted}}</q-item-label>    </small>
