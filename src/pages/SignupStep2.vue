  ...
  <q-page class="column poppinsFont page-content">
    <div class="col row custom-cols">
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 bgNewPrimary">
        ...
        <div class="mobile-view q-mt-md payment-section">
          <q-linear-progress
            size="5px"
  ...
  methods: {
    ...
    async checkCardValidity() {
      ...
      if (token) {
        ...
        if (res) {
          let emptyObj = []; //destroying the temp user details
          this.setTempUser(emptyObj);
