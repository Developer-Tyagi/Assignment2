<template>
  ...
  <q-form
   ...
   <br><p>If client already exists, select from list below</p>
   <q-select v-model="clientSelected" :options="clientsList" label="Select existing client"></q-select>
    </div>
      <div>
...
methods: {
    onSubmit () {
      ...
      this.$router.push('/addLeadDetails');
    },
    onReset () {
